...
- **pytest + pytest-asyncio** — тестирование с покрытием кода
...
├── middlewares/    # User registration, i18n, AntiFlood
...
- **AntiFlood**: в шаблоне есть встроенный Middleware для предотвращения флуда нажатиями или сообщениями
